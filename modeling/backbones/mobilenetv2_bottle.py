...
Stage4  conv7:  14  x 14  x 96      14  x 14  x 160     3                   9
    ...
    def __init__(
        ...
        self.conv2 = self._make_layer(Bottleneck, 1, int(16), structure[0], 1)
        ...
        self.conv8 = self._make_layer(Bottleneck, 6, int(320), structure[6], 1)
...
def mobilenetv2_300_bottle(num_classes, last_stride=2, width_mult=1, **kwargs):
    model = MobileNetV2_deep(
        num_classes,
        # loss=loss,
        width_mult=width_mult,

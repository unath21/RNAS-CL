...
class Bottle_Nonlocal(nn.Module):
    ...
    def __init__(self, n_feature, nl_c, nl_s, norm_method='batch_norm', batch_norm_kwargs=None):
        ...
        self.depthwise_conv_1 = nn.Conv2d(n_feature,
                                        n_feature,
                                        3,
                                        1,
                                        (3 - 1) // 2,
        ...
        self.depthwise_conv_2 = nn.Conv2d(n_feature,
                                        n_feature,
                                        3,
                                        1,
                                        (3 - 1) // 2,
        ...
        self.bn1 = ZeroInitBN(n_feature, **batch_norm_kwargs)
        self.bn2 = ZeroInitBN(n_feature, **batch_norm_kwargs)

    def forward(self, l):

        l = self.bn1(self.depthwise_conv_1(l))
        ...
        f = self.bn2(self.depthwise_conv_2(f))

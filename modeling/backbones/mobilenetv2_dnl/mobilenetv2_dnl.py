...
Stage4  conv7:  14  x 14  x 96      14  x 14  x 160     3                   9
    ...
    def __init__(
        ...
        self.non_local_1 = DNonlocal(int(24 * width_mult), nl_c, 1, norm_method=nl_norm_method, batch_norm_kwargs=batch_norm_kwargs)
        ...
        self.non_local_2 = DNonlocal(int(32 * width_mult), nl_c, 1, norm_method=nl_norm_method, batch_norm_kwargs=batch_norm_kwargs)
        ...
        self.non_local_3 = DNonlocal(int(64 * width_mult), nl_c, 1, norm_method=nl_norm_method, batch_norm_kwargs=batch_norm_kwargs)
        ...
        self.non_local_4 = DNonlocal(int(320 * width_mult), nl_c, 1, norm_method=nl_norm_method, batch_norm_kwargs=batch_norm_kwargs)
    ...
    def _set_ch_startpos_int(self, ch_startpos_int, index):
        startpos_int = torch.from_numpy(np.array(ch_startpos_int)).cuda()
...
def mobilenetv2_53_stage_dNL(num_classes, last_stride=1, pre_train=False, **kwargs):
...
def mobilenetv2_300_stage_dNL(num_classes, last_stride=1, pre_train=False, **kwargs):
    model = MobileNetV2_deep(
        num_classes,
        width_mult=1,
        nl_c=0.5,

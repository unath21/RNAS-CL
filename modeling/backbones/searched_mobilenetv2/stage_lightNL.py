...
Stage4  conv7:  14  x 14  x 96      14  x 14  x 160     3                   9
    ...
    def __init__(
        ...
        self.non_local_4 = Nonlocal(int(320 * width_mult), nl_c, 1, norm_method=nl_norm_method, batch_norm_kwargs=batch_norm_kwargs)
...
def mobilenetv2_53_stage_lightNL(num_classes, last_stride=1, pre_train=False, nl_c=0.5, **kwargs):
...
def mobilenetv2_200_stage_lightNL(num_classes, last_stride=1, pre_train=True, **kwargs):
    model = MobileNetV2_deep(
        num_classes,
        width_mult=1,
        nl_c=1.0,
    ...
    if pre_train:
        ...
        print('imagnet pre-trained model loaded')
    return model

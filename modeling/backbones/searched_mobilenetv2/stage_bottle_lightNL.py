...
import warnings
import pickle
from .mobilenet_base import Bottle_Nonlocal
...
Stage4  conv7:  14  x 14  x 96      14  x 14  x 160     3                   9
    ...
    def __init__(
        ...
        self.non_local_1 = Bottle_Nonlocal(int(24 * width_mult), 1, 1, norm_method=nl_norm_method, batch_norm_kwargs=batch_norm_kwargs)

        self.conv4 = self._make_layer(Bottleneck, 6, int(32 * width_mult), structure[2], 2)
        self.non_local_2 = Bottle_Nonlocal(int(32 * width_mult), 1, 1, norm_method=nl_norm_method, batch_norm_kwargs=batch_norm_kwargs)

        self.conv5 = self._make_layer(Bottleneck, 6, int(64 * width_mult), structure[3], 2)
        self.non_local_3 = Bottle_Nonlocal(int(64 * width_mult), 1, 1, norm_method=nl_norm_method, batch_norm_kwargs=batch_norm_kwargs)
        ...
        self.non_local_4 = Bottle_Nonlocal(int(320 * width_mult), 1, 1, norm_method=nl_norm_method, batch_norm_kwargs=batch_norm_kwargs)
...
def mobilenetv2_53_stage_bottle_lightNL(num_classes, last_stride=1, pre_train=False, **kwargs):
